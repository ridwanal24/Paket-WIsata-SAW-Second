...
if (isset($_POST['save'])) 
{
	$koneksi->query("UPDATE tb_alternatif SET id_paketwisata='$_POST[id_paketwisata]', harga=$_POST[hrg], jumlah_wisata='$_POST[jml_wisata]', lama_tour='$_POST[lm_tour]' WHERE id_alternatif='$_GET[id]'");
